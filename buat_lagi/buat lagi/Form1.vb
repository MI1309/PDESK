Public Class Form1
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Dim niab, nitu, uts, uas, sepuluh, duapuluh, tigapuluh, empatpuluh, total As Double

        niab = Val(TextBox1.Text)
        nitu = Val(TextBox2.Text)
        uts = Val(TextBox3.Text)
        uas = Val(TextBox4.Text)

        total = (niab + nitu + uts + uas) / 4
        sepuluh = (10 / 100) * total
        duapuluh = (20 / 100) * total
        tigapuluh = (30 / 100) * total
        empatpuluh = (40 / 100) * total
